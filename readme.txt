...
== Description ==
Lists all abilities registered on the site (by any plugin or core) and lets admins disable or re-enable them.
Disabled abilities are blocked by overriding their execute_callback to always return an error.
